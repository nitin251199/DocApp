...
export default function Home(props) {
  ...
  return (
    <div>
      ...
      >
        <span style={{ fontSize: 55, color: "white", fontWeight: "bolder" }}>
          Search Your Doctor, Make an appointment
        </span>
        <span style={{ fontSize: 30, color: "white", margin: 5 }}>
